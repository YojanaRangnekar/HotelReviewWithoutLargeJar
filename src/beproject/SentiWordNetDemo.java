...
public class SentiWordNetDemo{
     ...
     */
    SentiWordnet sentiwordnet = new SentiWordnet("C:\\BE_Project\\SentiWordNet.txt");     
    ...
    public void load(String fileName) {
        try {
            BufferedReader reader = new BufferedReader(new FileReader("C:\\BE_Project\\SentiWordNet.txt"));
            String line;
            text = "";
