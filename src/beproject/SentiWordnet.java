...
public class SentiWordnet {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("untrained#a " + sentiwordnet.extract("untrained", "a"));
        System.out.println("take#n " + sentiwordnet.extract("take", "n"));
        //  System.out.println("done#n "+sentiwordnet.extract("done", "n"));
